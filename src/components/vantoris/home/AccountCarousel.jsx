...
const TYPE_GRADIENTS = {
  Personal: 'from-brass/15 to-brass/5',
  Joint: 'from-champagne/15 to-champagne/5',
  Business: 'from-slate/40 to-slate/10',
  Organization: 'from-mint/10 to-mint/5',
};
      ...
      <div className="overflow-x-auto vantoris-scroll -mx-5 px-5 pb-1">
        <div className="flex gap-3" style={{ width: 'max-content' }}>
          {accounts.map((account, idx) => (
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${TYPE_GRADIENTS[account.account_type] || TYPE_GRADIENTS.Personal} opacity-60`} />
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <div className="w-9 h-9 rounded-xl bg-brass/15 border border-brass/10 flex items-center justify-center">
