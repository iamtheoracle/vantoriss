...
const highlights = [
          {
            title: 'Now streaming',
            description: 'See live lectures, community town halls, and cultural events as they happen.',
          },
          {
            title: 'Upcoming sessions',
            description: 'Browse scheduled AMAs, workshops, and club livestreams with reminders.',
          },
          {
            title: 'Backstage tools',
            description: 'Prepare host notes, audience prompts, and moderation controls for future streams.',
          },
];
  ...
  return (
    <main className="flex-1 px-4 pb-8 pt-6 sm:px-6">
      <section className="rounded-[28px] border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-6 shadow-2xl shadow-purple-900/20 backdrop-blur-md">
        ...
        <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white">Live</h1>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-white/75">Real-time lectures, events, and creator broadcasts that bring the campus network together.</p>
      </section>
