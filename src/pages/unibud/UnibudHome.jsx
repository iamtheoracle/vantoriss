...
const highlights = [
          {
            ...
            description: 'Catch up on featured communities, campus news, and creator stories in one feed.',
          },
          {
            title: 'Academic momentum',
            description: 'Jump into classes, revision rooms, and deadlines with contextual insights.',
          },
          {
            title: 'Live connections',
            description: 'Find active spaces to listen, chat, and collaborate with students right now.',
          },
];

export default function UnibudHome() {
  return (
    <main className="flex-1 px-4 pb-8 pt-6 sm:px-6">
      <section className="rounded-[28px] border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-6 shadow-2xl shadow-purple-900/20 backdrop-blur-md">
        ...
        <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white">UNIBUD</h1>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-white/75">A social learning home built for discovery, connection, and student momentum.</p>
      </section>
