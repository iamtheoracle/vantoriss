...
const highlights = [
          {
            ...
            description: 'Explore interest-based groups, society announcements, and upcoming meetups.',
          },
          {
            title: 'Collaboration rooms',
            description: 'Share ideas, co-create projects, and organize events with your peers.',
          },
          {
            title: 'Campus pulse',
            description: 'Discover volunteer drives, competitions, and student-led initiatives near you.',
          },
];
  ...
  return (
    <main className="flex-1 px-4 pb-8 pt-6 sm:px-6">
      <section className="rounded-[28px] border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-transparent p-6 shadow-2xl shadow-purple-900/20 backdrop-blur-md">
        ...
        <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white">Communities</h1>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-white/75">Student clubs, creator circles, and campus communities designed for meaningful collaboration.</p>
      </section>
