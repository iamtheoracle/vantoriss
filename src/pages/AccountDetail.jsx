...
const WITHDRAWAL_METHODS = [
  { value: 'ACH Transfer', label: 'ACH Transfer', desc: '1-2 Business Days · $0 fee · Up to $25,000 daily' },
  { value: 'Domestic Wire', label: 'Domestic Wire', desc: 'Same day · $25 fee · Up to $100,000 daily' },
  { value: 'International Wire', label: 'International Wire', desc: '2-5 Business Days · $45 fee · Global' },
  { value: 'Internal Transfer', label: 'Internal Transfer', desc: 'Instant · $0 fee · Between Vantoris accounts' },
  { value: 'External Linked Bank', label: 'External Linked Bank', desc: '2-3 Business Days · $0 fee' },
  { value: 'Check by Mail', label: 'Check by Mail', desc: '5-7 Business Days · $10 fee · Up to $10,000' },
  { value: 'Crypto Withdrawal', label: 'Crypto Withdrawal', desc: 'Network confirmation · Network fee applies' },
];
        ...
        <DialogContent className="bg-[#0E1A2B] border-[#242D38] max-w-sm">
          ...
          <div className="space-y-4 mt-2">
            ...
            <div>
              ...
              {wForm.method && (
                <p className="text-[#AAB4C3] text-xs mt-1.5">
                  {WITHDRAWAL_METHODS.find(m => m.value === wForm.method)?.desc}
                </p>
              )}
            </div>
            <div>
